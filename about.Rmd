...
The data can be accessed through the interface of the atlas, or downloaded directly from the [GitHub page](https://github.com/LingConLab/TALD/tree/master/data/orig_table).
