...
For map visualizations we use the [Lingtypology package](https://github.com/ropensci/lingtypology) [@moroz2017] and the [RCaucTile package](https://lingconlab.github.io/RCaucTile/) [@moroz2025] for [R](https://www.r-project.org/).
...
This visualization is analogous to the General datapoints visualization but displays languages as rectangles and allows for color-coding based on specific linguistic values. The Tile map visualization was designed specifically for TALD with the R package [RCaucTile](https://lingconlab.github.io/RCaucTile/) [@moroz2025].
