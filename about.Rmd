...
This visualization is analogous to the General datapoints visualization but displays languages as rectangles and allows for color-coding based on specific linguistic values. The Tile map visualization was designed specifically for TALD with the R package RCaucTile [@moroz2025].
