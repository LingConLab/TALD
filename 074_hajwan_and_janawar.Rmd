---
title: Meaning of the words *hajwan* and *janawar*
author: Daria Tsikh
date: 'Last update: August 2026'
bibliography: ./data/orig_bib/hajwan_and_janawar.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [data and maps](074_hajwan_and_janawar_map.html).
...
```{r, child='data/orig_rmd/hajwan_and_janawar.Rmd'}
```
