---
title: Days after today (Maps & Data)
author: Timofey Dedov
date: 'Last update: June 2022'
bibliography: ./data/orig_bib/days_after_today.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](032_days_after_today.html)
...
```{r, child='data/orig_rmd/days_after_today_map.Rmd'}
```
