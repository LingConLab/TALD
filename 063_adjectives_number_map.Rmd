---
title: Specialized number agreement of adnominal adjectives (Maps & Data)
author: Aigul Zakirova
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/adjectives_number.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](063_adjectives_number.html)
...
```{r, child='data/orig_rmd/adjectives_number_map.Rmd'}
```
