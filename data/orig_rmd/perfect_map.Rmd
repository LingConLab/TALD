...
read_tsv("../orig_table/perfect.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'perfect_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Structure {.tabset .tabset-fade .tabset-pills #m1} 
...
## Current relevance {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/perfect.tsv) the whole dataset.
