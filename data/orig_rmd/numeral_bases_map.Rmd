...
read_tsv("../orig_table/numeral_bases.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_bases_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Base of numeral system {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_bases.tsv) the whole dataset.
