...
read_tsv("../orig_table/agreement_of_adpositions.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'agreement_of_adpositions_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Adpositional agreement with the absolutive/nominative {.tabset .tabset-fade .tabset-pills #m1} 
...
## Percentage of agreeing adpositions {.tabset .tabset-fade .tabset-pills #m2} 
...
## Percentage of agreeing adpositions allowing independent use {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/agreement_of_adpositions.tsv) the whole dataset.
