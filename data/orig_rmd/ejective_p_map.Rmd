...
read_tsv("../orig_table/ejective_p.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'ejective_p_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of ejective p {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/ejective_p.tsv) the whole dataset.
