...
read_tsv("../orig_table/evidentiality_tense.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'evidentiality_tense_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Indirect evidential perfect {.tabset .tabset-fade .tabset-pills #m1} 
...
## Evidentiality in the tense system {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/evidentiality_tense.tsv) the whole dataset.
