...
read_tsv("../orig_table/laterals.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'laterals_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/laterals.tsv) the whole dataset.
