...
read_tsv("../orig_table/numeral_origin.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_origin_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Origin of the numeral marker {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_origin.tsv) the whole dataset.
