...
|                        |run-`r add_gloss("IMP.PL")`                                         |let_go-`r add_gloss("IMP")`                |
|Dargwa (Kubachi)        |_diːq’-**aː**_                                                      |*baːq’-a*                                  |
|                        |work-`r add_gloss("IMP.PL")`                                        |do-`r add_gloss("IMP")`                    |
...
|            |`r add_gloss("M")`-sleep-`r add_gloss("IMP.SG")`|`r add_gloss("HPL")`-sleep-`r add_gloss("IMP.PL")`|
|Transitive  |*b-uc-a*                                        |*b-uc-aja*                                        |
|            |`r add_gloss("N")`-hold-`r add_gloss("IMP.SG")` |`r add_gloss("N")`-hold-`r add_gloss("IMP.PL")`   |
