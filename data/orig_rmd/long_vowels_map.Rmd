...
read_tsv("../orig_table/long_vowels.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'long_vowels_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of long vowels {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/long_vowels.tsv) the whole dataset.
