...
read_tsv("../orig_table/take_hold_catch.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'take_hold_catch_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Colexification of 'hold' and 'take' {.tabset .tabset-fade .tabset-pills #m1} 
...
## Colexification of 'hold' and 'catch' {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/take_hold_catch.tsv) the whole dataset.
