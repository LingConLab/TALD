...
article_citation <- BibEntry(bibtype = 'Incollection', 
 key='philippovanasledskova2022',
 title='Adpositions',
 author='Philippova, Tatiana and Nasledskova, Polina',
 year='2022',
...
```
(@fifteen) Tsakhur (Lezgic) [@sosenskaya1999post: 127]
```{r, results='asis'}
...
gloss_example(transliteration = "eli ɣudes ħalt’-o-ł-xor b-ik’i-x ħat’an-**ƛ’o** ƛexuzaƛ’or",
              glosses = "1PL.ABS daily work-OBL-CONT-VERS 1PL-go-PRS Sunday-**SUP.ESS** except",
