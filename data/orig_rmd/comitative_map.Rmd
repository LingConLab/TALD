...
read_tsv("../orig_table/comitative.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'comitative_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Type of marking {.tabset .tabset-fade .tabset-pills #m1} 
...
## Case form {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/comitative.tsv) the whole dataset.
