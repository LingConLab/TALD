...
(@seven)	Karata [@magomedovaxalidova2001: 97, 113, 154, 288, 296]
...
(@eight)	Karata [@magomedovaxalidova2001: 97, 113, 154, 288, 296]	
a. 
```{r}
...
On the one hand, in the singular, gender and number in Avar are expressed in the same morpheme, therefore the agreement markers in the singular are cumulative. On the other hand, the plural marker *-l* only expresses the plural value without indicating the gender of the target. For the purposes of this chapter, I classify languages like Avar as having specialized number agreement. However, I also discuss gender neutralization in the plural separately (see [Map 4](063_adjectives_number_map.html#m4) and @genderneutralization). 
...
Yet another situation where the border between number agreement and other grammatical phenomena is blurred is described by [@graschenkov2021], [@lyutikova2021] and [@polinskydraft2015], who note that, in some of its uses, the distributive marker *-t'a* (@twelve) in Khwarshi and Tsez (< Tsezic) functionally resembles a plural agreement marker. For example, with some adjectives it is obligatory in the plural (@thirteen).
...
This feature reflects the presence or absence of specialized number agreement, as defined above in @intro. Three major groups of languages are identified, corresponding to Values 1-3:
...
Value 2 (conditioned agreement) includes languages where adnominal number agreement is conditioned by certain factors. These factors are discussed in @conditioning.
...
**[Map 1](064_adjectives_number_map.html#m1) shows the presence or absence of specialized number agreement in adnominal adjectives**
...
**[Map 3](064_adjectives_number_map.html#m3) shows specialized morphological means of number agreement.**
...
**[Map 4](064_adjectives_number_map.html#m4) shows the presence or absence of full neutralization of gender agreement in the plural.**
...
**[Map 5](064_adjectives_number_map.html#m5) shows distributive marking bordering on plural agreement.**
...
abs — absolutive; attr — attributive; caus — causative; dat — dative; dem — demonstrative; distr — distributive; erg — ergative; f — feminine gender; hpl — human plural gender; ipf — imperfective; lat — lative; m — masculine gender; n — neuter gender; n1 — neuter gender I; nm — non-masculine gender; npl — neutral plural gender; obl — oblique; pf — perfective; pl — plural; pret — preterite; pst — past; restr — restrictive; sg — singular; th — thematic; wit — witnessed
