...
read_tsv("../orig_table/numeral_one.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_one_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of the numeral marker in the numeral ‘1’ {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_one.tsv) the whole dataset.
