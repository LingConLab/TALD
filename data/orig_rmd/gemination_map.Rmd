...
read_tsv("../orig_table/gemination.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'gemination_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of geminates {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/gemination.tsv) the whole dataset.
