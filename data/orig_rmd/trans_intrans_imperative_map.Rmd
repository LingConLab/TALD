...
read_tsv("../orig_table/trans_intrans_imperative.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'trans_intrans_imperative_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## General distinction in suffixes {.tabset .tabset-fade .tabset-pills #m1} 
...
## Distinction in plural form {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/trans_intrans_imperative.tsv) the whole dataset.
