...
read_tsv("../orig_table/farewell_wishes.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'farewell_wishes_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/farewell_wishes.tsv) the whole dataset.
