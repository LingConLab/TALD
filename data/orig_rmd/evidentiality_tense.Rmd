...
|              |Aorist                                                                                   |Perfect                                                                                             |
|--------------|-----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
|Aorist/Perfect|`r gloss_example("c'al-**ana**", "read-AOR")`                             |`r gloss_example("c'al-**un** **b-ugo**", "read-CVB N-COP")`                             |
|Pluperfect    |`r gloss_example("c'al-un **b-uk'-ana**", "read-CVB N-be-AOR")`           |`r gloss_example("c'al-un **b-uk'-un** **b-ugo**", "read-CVB N-be-CVB N-COP")`           |
|Imperfect     |`r gloss_example("c'al-ul-e-b **b-uk'-ana**", "read-PRS-PTCP-N N-be-AOR")`|`r gloss_example("c'al-ul-e-b **b-uk'-un** **b-ugo**", "read-PRS-PTCP-N N-be-CVB N-COP")`|
