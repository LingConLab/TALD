...
read_tsv("../orig_table/caritive_attr.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'caritive_attr_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Caritive marker in attributive phrases {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/caritive_attr.tsv) the whole dataset.
