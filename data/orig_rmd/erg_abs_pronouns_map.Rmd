...
read_tsv("../orig_table/erg_abs_pronouns.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'erg_abs_pronouns_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Ergative-absolutive distinction in personal pronouns {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/erg_abs_pronouns.tsv) the whole dataset.
