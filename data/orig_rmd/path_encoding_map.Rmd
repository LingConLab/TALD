...
read_tsv("../orig_table/path_encoding.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'path_encoding_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Path Encoding {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/path_encoding.tsv) the whole dataset.
