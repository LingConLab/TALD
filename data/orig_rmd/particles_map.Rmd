...
read_tsv("../orig_table/particles.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'particles_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Particle inventory {.tabset .tabset-fade .tabset-pills #m1} 
...
## Structure {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/particles.tsv) the whole dataset.
