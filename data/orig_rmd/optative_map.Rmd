...
map.feature(all_genpoints$lang4map,
            latitude = all_genpoints$lat,
            longitude = all_genpoints$lon,
            features = factor(all_genpoints$value2),
            title = all_genpoints$value2_name[1],
            color = 'magma',
            stroke.features = 'a',
            stroke.color = 'black',
            stroke.radius = 1,
...
map.feature(alldata_clean$lang4map,
            ...
            stroke.radius = 1,
            tile = 'Stamen.TonerLite',
            title = alldata_clean$value2_name[1],
            legend = TRUE,
            legend.position = 'bottomleft', 
            label = alldata_clean$lang,
            zoom.control = TRUE,
...
map.feature(all_genpoints$lang4map,
            latitude = all_genpoints$lat,
            longitude = all_genpoints$lon,
            features = factor(all_genpoints$value3),
            title = all_genpoints$value3_name[1],
            color = 'magma',
            stroke.features = 'a',
            stroke.color = 'black',
            stroke.radius = 1,
...
map.feature(alldata_clean$lang4map,
            latitude = alldata_clean$lat, 
            longitude = alldata_clean$lon,
            features = as.factor(alldata_clean$value3),
            color = 'magma',
            stroke.features = 'a',
            stroke.color = 'black',
            stroke.radius = 1,
            tile = 'Stamen.TonerLite',
            title = alldata_clean$value3_name[1],
            legend = TRUE,
            legend.position = 'bottomleft', 
            label = alldata_clean$lang,
            zoom.control = TRUE,
...
map.feature(all_genpoints$lang4map,
            latitude = all_genpoints$lat,
            longitude = all_genpoints$lon,
            features = factor(all_genpoints$value4),
            title = all_genpoints$value4_name[1],
            color = 'magma',
            stroke.features = 'a',
            stroke.color = 'black',
            stroke.radius = 1,
...
map.feature(alldata_clean$lang4map,
            latitude = alldata_clean$lat, 
            longitude = alldata_clean$lon,
            features = as.factor(alldata_clean$value4),
            color = 'magma',
            stroke.features = 'a',
            stroke.color = 'black',
            stroke.radius = 1,
            tile = 'Stamen.TonerLite',
            title = alldata_clean$value4_name[1],
            legend = TRUE,
            legend.position = 'bottomleft', 
            label = alldata_clean$lang,
            zoom.control = TRUE,
