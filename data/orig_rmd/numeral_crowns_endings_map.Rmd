...
read_tsv("../orig_table/numeral_crowns_endings.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_crowns_endings_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Special endings for crowns from 30 to 90 {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_crowns_endings.tsv) the whole dataset.
