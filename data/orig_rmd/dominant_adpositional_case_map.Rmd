...
read_tsv("../orig_table/dominant_adpositional_case.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'dominant_adpositional_case_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Dominant case type {.tabset .tabset-fade .tabset-pills #m1} 
...
## Abstract default cases {.tabset .tabset-fade .tabset-pills #m2} 
...
## Spatial dominant cases {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/dominant_adpositional_case.tsv) the whole dataset.
