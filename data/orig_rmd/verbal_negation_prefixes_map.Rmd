...
read_tsv("../orig_table/verbal_negation_prefixes.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'verbal_negation_prefixes_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Verbal negation with prefixes, infixes and particles {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/verbal_negation_prefixes.tsv) the whole dataset.
