...
read_tsv("../orig_table/uvular_voiced_stop.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'uvular_voiced_stop_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of uvular voiced stop {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/uvular_voiced_stop.tsv) the whole dataset.
