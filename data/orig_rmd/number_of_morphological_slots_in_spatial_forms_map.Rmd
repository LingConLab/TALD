...
read_tsv("../orig_table/number_of_morphological_slots_in_spatial_forms.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'number_of_morphological_slots_in_spatial_forms_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Type of spatial system {.tabset .tabset-fade .tabset-pills #m1} 
...
## Type of trimorphemic system {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/number_of_morphological_slots_in_spatial_forms.tsv) the whole dataset.
