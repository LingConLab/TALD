...
read_tsv("../orig_table/imperative_interjections.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'imperative_interjections_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Phonological form of the imperative interjection 'here, take it!' {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/imperative_interjections.tsv) the whole dataset.
