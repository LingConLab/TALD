...
As can be seen from [Map 5](048_demonstratives_map.html#m5), there is no language that uses the S-prox demonstrative as the most frequent anaphoric mean. In three-term polycentric systems the S&A dist demonstrative prevail, while in monocentric ones S-dist and S-far compete.
