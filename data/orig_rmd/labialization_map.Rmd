...
read_tsv("../orig_table/labialization.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'labialization_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of labialized consonants {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/labialization.tsv) the whole dataset.
