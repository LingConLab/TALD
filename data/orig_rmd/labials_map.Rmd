...
read_tsv("../orig_table/labials.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'labials_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Inventory of v-like consonants {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/labials.tsv) the whole dataset.
