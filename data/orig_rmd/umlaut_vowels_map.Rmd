...
read_tsv("../orig_table/umlaut_vowels.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'umlaut_vowels_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of umlaut vowels {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/umlaut_vowels.tsv) the whole dataset.
