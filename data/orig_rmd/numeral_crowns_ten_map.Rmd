...
read_tsv("../orig_table/numeral_crowns_ten.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_crowns_ten_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Origin of the ‘ten’ component in crowns {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_crowns_ten.tsv) the whole dataset.
