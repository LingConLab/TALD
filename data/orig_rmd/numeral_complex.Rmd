...
In other languages, numeral markers appear on non-final components of a complex numeral as well. This is typical for languages of the Tsezic and Lezgic branches, as shown in examples (@hinuq_53) and (@lezgian_3895). In such languages hundreds, and often crowns as well, preserve the marker.
...
(@lezgian_3895) Standard Lezgian [@haspelmath1993: 231]
```{r, echo=FALSE}
