...
read_tsv("../orig_table/caritive_adv.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'caritive_adv_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Caritive marker in adverbial phrases {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/caritive_adv.tsv) the whole dataset.
