...
read_tsv("../orig_table/causatives.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'causatives_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Extent of boundedness {.tabset .tabset-fade .tabset-pills #m1} 
...
## Attested expression types {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/causatives.tsv) the whole dataset.
