...
read_tsv("../orig_table/inclusive_exclusive_distinction_in_personal_pronouns.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'inclusive_exclusive_distinction_in_personal_pronouns_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## The presence of exclusive/inclusive distinction in personal pronouns {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/inclusive_exclusive_distinction_in_personal_pronouns.tsv) the whole dataset.
