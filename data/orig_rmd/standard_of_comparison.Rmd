...
In the languages of Daghestan the standard of comparison is usually marked with a spatial form (see [2.1 Spatial forms]). A few languages feature dedicated comparative markers (see [2.2 Dedicated comparative markers]).


### Spatial forms

In comparative constructions, most languages of Daghestan mark the standard of comparison with a spatial form. However, variation is observed with respect to both the directionality marker (see [2.1.1 Directionality markers]) and the localization marker (see [2.1.2 Localization markers]) employed (on directionality and localization markers see the chapter on [Spatial cases]). 
...
The most common localization marker in spatial forms encoding the standard of comparison is **SUPER** (location on a surface),[^6] cf. (@two). It is found in 19 languages (see [Table 5](#t5)).

##### Table 5. SUPER markers {#t5 -}
...
In all Andic languages (except for Northern Akhvakh) the localization marker **CONT** (localization in contact with a surface) is found, cf. example (@five) and [Table 6](#t6). In Karata, CONT is used alongside SUPER [@pasquereau2010: 60]. It is also used in the varieties of Karata spoken in Tukita (Michael Daniel p.c.) and Anchix (Konstantin Filatov p.c.). 
