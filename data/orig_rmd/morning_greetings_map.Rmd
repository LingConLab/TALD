...
read_tsv("../orig_table/morning_greetings.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'morning_greetings_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Type of morning greeting {.tabset .tabset-fade .tabset-pills #m1} 
...
## Borrowing source {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/morning_greetings.tsv) the whole dataset.
