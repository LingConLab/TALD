...
read_tsv("../orig_table/standard_of_comparison.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'standard_of_comparison_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Spatial vs. dedicated markers {.tabset .tabset-fade .tabset-pills #m1} 
...
## Localization markers {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/standard_of_comparison.tsv) the whole dataset.
