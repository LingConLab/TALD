...
read_tsv("../orig_table/numeral_twoten.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_twoten_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of the numeral marker in the numerals ‘2’—‘10’ {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_twoten.tsv) the whole dataset.
