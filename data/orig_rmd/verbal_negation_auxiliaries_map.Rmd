...
read_tsv("../orig_table/verbal_negation_auxiliaries.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'verbal_negation_auxiliaries_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Verbal negation with auxiliaries {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/verbal_negation_auxiliaries.tsv) the whole dataset.
