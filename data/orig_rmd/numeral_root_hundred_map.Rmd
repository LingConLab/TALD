...
read_tsv("../orig_table/numeral_root_hundred.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_root_hundred_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Root for ‘hundred’ {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_root_hundred.tsv) the whole dataset.
