---
title: Special endings for crowns from 30 to 90 (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_crowns_endings.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](042_numeral_crowns_endings.html)
...
```{r, child='data/orig_rmd/numeral_crowns_endings_map.Rmd'}
```

```{r, results='asis'}PrintBibliography(bib)```
