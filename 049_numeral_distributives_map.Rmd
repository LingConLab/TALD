---
title: Derivation of distributives (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_distributives.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](049_numeral_distributives.html)
...
```{r, child='data/orig_rmd/numeral_distributives_map.Rmd'}
```
