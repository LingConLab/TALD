---
title: Gender agreement slot in adjectives (Maps & Data)
author: Alina Khurges
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/gender_agreement_in_nps_in_adjectives.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](070_gender_agreement_in_nps_in_adjectives.html)
...
```{r, child='data/orig_rmd/gender_agreement_in_nps_in_adjectives_map.Rmd'}
```
