---
title: Root for ‘hundred’ (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_root_hundred.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](047_numeral_root_hundred.html)
...
```{r, child='data/orig_rmd/numeral_root_hundred_map.Rmd'}
```
