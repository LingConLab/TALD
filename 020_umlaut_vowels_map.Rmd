---
title: Umlaut vowels (Maps & Data)
author: George Moroz
date: 'Last update: November 2021'
bibliography: ./data/orig_bib/umlaut_vowels.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](020_umlaut_vowels.html)
...
```{r, child='data/orig_rmd/umlaut_vowels_map.Rmd'}
```
