---
title: Lateral fricatives and affricates
author: George Moroz, Vasiliy Zerzele
date: 'Last update: February 2026'
bibliography: ./data/orig_bib/laterals.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [data and maps](014_laterals_map.html).
...
```{r, child='data/orig_rmd/laterals.Rmd'}
```
