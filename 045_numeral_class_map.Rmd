---
title: Presence of a class suffix in the numeral marker (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_class.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](045_numeral_class.html)
...
```{r, child='data/orig_rmd/numeral_class_map.Rmd'}
```
