---
title: Farewell wishes (Maps & Data)
author: Nina Dobrushina
date: 'Last update: September 2023'
bibliography: ./data/orig_bib/farewell_wishes.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](052_farewell_wishes.html)
...
```{r, child='data/orig_rmd/farewell_wishes_map.Rmd'}
```
