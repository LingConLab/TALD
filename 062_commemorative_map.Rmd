---
title: Commemorative formulas (Maps & Data)
author: Nina Dobrushina
date: 'Last update: April 2025'
bibliography: ./data/orig_bib/commemorative.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](062_commemorative.html)
...
```{r, child='data/orig_rmd/commemorative_map.Rmd'}
```
