---
title: Gender agreement slot in verb forms (Maps & Data)
author: Ivan Olkhov
...
See [chapter](071_gender_agreement_slot_in_verb_forms.html)
...
```{r, child='data/orig_rmd/gender_agreement_slot_in_verb_forms_map.Rmd'}
```
