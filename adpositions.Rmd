...
gloss_example(transliteration = "eli mariyat-**qo-r** ƛexuzaƛ’or c’alduqan-za-qo-r xabaryay-nč’i",
              glosses = "we Mariyat-**POSS-LAT** except student-OBL.PL-POSS-LAT talk-PST.WIT.NEG",
...
```{r}
make_gloss_list(readxl::read_xlsx("data/glosses.xlsx"), remove_glosses = c("witnessed"))
```
