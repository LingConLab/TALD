---
title: Negation with reduplication (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/verbal_negation_reduplication.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](068_verbal_negation_reduplication.html)
...
```{r, child='data/orig_rmd/verbal_negation_reduplication_map.Rmd'}
```
