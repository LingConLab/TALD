---
title: Presence of the numeral marker in ordinals (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_ordinals.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](046_numeral_ordinals.html)
...
```{r, child='data/orig_rmd/numeral_ordinals_map.Rmd'}
```
