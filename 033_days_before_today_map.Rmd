---
title: Days before today (Maps & Data)
author: Timofey Dedov
date: 'Last update: June 2022'
bibliography: ./data/orig_bib/days_before_today.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](033_days_before_today.html)
...
```{r, child='data/orig_rmd/days_before_today_map.Rmd'}
```
