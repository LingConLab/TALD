---
title: Imperative interjection ‘here, take it!’ (Maps & Data)
author: Timur Maisak
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/imperative_interjections.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](069_imperative_interjections.html)
...
```{r, child='data/orig_rmd/imperative_interjections_map.Rmd'}
```
