---
title: Negation with auxiliaries (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/verbal_negation_auxiliaries.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](067_verbal_negation_auxiliaries.html)
...
```{r, child='data/orig_rmd/verbal_negation_auxiliaries_map.Rmd'}
```
