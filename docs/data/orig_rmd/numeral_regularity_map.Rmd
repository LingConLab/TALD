...
read_tsv("../orig_table/numeral_regularity.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_regularity_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Regularity of the numeral marker {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_regularity.tsv) the whole dataset.
