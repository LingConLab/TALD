...
read_tsv("../orig_table/prohibitives.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'prohibitives_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/prohibitives.tsv) the whole dataset.
