...
gloss_example(transliteration = "c’ːelo-g-e sːigi",
              glosses = "guest.PL-LOC-ESS in_front",
...
As can be seen from [Map 1](30_dominant_adpositional_case_map.html#m1), the recruitment of an abstract case as a dominant adpositional case is the most widespread option (24+ languages), followed by a spatial (6 languages) and an ambiguous case (4 languages).

### Value 2. Abstract default cases

[Map 2](30_dominant_adpositional_case_map.html#m2) zooms in on languages with an abstract case serving as the dominant one.
...
gloss_example(transliteration = "qal-la sala=b",
              glosses = "house-GEN in_front-ESS",
              free_translation = "in front of the house")
```
b.
```{r}
...
The value ‘irrelevant’ is assigned to languages whose dominant adpositional case is a spatial one and to languages falling in the categories “None” and “NA” on [Map 1](30_dominant_adpositional_case_map.html#m1).

### Value 3. Spatial dominant cases

[Map 3](30_dominant_adpositional_case_map.html#m3) looks deeper into languages where the dominant adpositional case is a spatial one. The ones that are treated as ambiguous on [Map 1](30_dominant_adpositional_case_map.html#m1) are mapped here.
...
The value ‘Irrelevant’ is assigned to languages whose dominant adpositional case is one of the abstract cases and to languages falling in the categories “None” and “NA” on [Map 1](30_dominant_adpositional_case_map.html#m1).
