...
read_tsv("../orig_table/jussive.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'jussive_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of dedicated affix {.tabset .tabset-fade .tabset-pills #m1} 
...
## Say-based suffix {.tabset .tabset-fade .tabset-pills #m2} 
...
## Causative suffix {.tabset .tabset-fade .tabset-pills #m3} 
...
## Coexpression by optative {.tabset .tabset-fade .tabset-pills #m4} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/jussive.tsv) the whole dataset.
