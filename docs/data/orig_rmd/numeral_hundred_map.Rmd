...
read_tsv("../orig_table/numeral_hundred.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_hundred_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of the numeral marker in the numeral ‘100’ {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_hundred.tsv) the whole dataset.
