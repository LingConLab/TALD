...
read_tsv("../orig_table/adjectives_number.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'adjectives_number_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Is number marking present on adnominal adjectives? {.tabset .tabset-fade .tabset-pills #m1} 
...
## Conditioning of number marking on attributive adjectives {.tabset .tabset-fade .tabset-pills #m2} 
...
## How is number expressed on adnominal adjectives {.tabset .tabset-fade .tabset-pills #m3} 
...
## Gender neutralization in plural {.tabset .tabset-fade .tabset-pills #m4} 
...
## Distributive marking bordering on plural agreement {.tabset .tabset-fade .tabset-pills #m5} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/adjectives_number.tsv) the whole dataset.
