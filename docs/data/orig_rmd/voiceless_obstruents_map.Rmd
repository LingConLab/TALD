...
read_tsv("../orig_table/voiceless_obstruents.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'voiceless_obstruents_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Type of the contrast {.tabset .tabset-fade .tabset-pills #m1} 
...
## Contents of the contrast {.tabset .tabset-fade .tabset-pills #m2} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/voiceless_obstruents.tsv) the whole dataset.
