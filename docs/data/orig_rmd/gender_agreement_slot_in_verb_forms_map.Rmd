...
read_tsv("../orig_table/gender_agreement_slot_in_verb_forms.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'gender_agreement_slot_in_verb_forms_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Root agreement {.tabset .tabset-fade .tabset-pills #m1} 
...
## Affix agreement {.tabset .tabset-fade .tabset-pills #m2} 
...
## Percentage of agreeing verbs {.tabset .tabset-fade .tabset-pills #m3} 
...
## Prefix {.tabset .tabset-fade .tabset-pills #m4} 
...
## Other slots {.tabset .tabset-fade .tabset-pills #m5} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/gender_agreement_slot_in_verb_forms.tsv) the whole dataset.
