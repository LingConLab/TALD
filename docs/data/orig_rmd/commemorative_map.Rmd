...
read_tsv("../orig_table/commemorative.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'commemorative_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Rahmat {.tabset .tabset-fade .tabset-pills #m1} 
...
## May his sins be washed away {.tabset .tabset-fade .tabset-pills #m2} 
...
## ʡaˁpa {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/commemorative.tsv) the whole dataset.
