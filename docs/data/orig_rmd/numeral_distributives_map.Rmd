...
read_tsv("../orig_table/numeral_distributives.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_distributives_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Derivation of distributives {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_distributives.tsv) the whole dataset.
