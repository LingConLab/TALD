...
read_tsv("../orig_table/hajwan_and_janawar.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'hajwan_and_janawar_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Translation of "hajwan" {.tabset .tabset-fade .tabset-pills #m1} 
...
## Translation of dʒanawar {.tabset .tabset-fade .tabset-pills #m2} 
...
## The presence of 'wolf' meaning {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/hajwan_and_janawar.tsv) the whole dataset.
