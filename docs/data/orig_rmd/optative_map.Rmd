...
read_tsv("../orig_table/optative.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'optative_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/optative.tsv) the whole dataset.
