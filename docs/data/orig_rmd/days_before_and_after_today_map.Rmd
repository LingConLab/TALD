...
read_tsv("../orig_table/days_before_and_after_today.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'days_before_and_after_today_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Amount of distinct terms for days before today {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/days_before_and_after_today.tsv) the whole dataset.
