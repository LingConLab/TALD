...
read_tsv("../orig_table/gender_agreement_slot.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'gender_agreement_slot_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Gender agreement slot in nominal inflectional paradigms {.tabset .tabset-fade .tabset-pills #m1} 
...
## Gender agreement slot in the spatial inventory {.tabset .tabset-fade .tabset-pills #m2} 
...
## Gender agreement slot in core cases {.tabset .tabset-fade .tabset-pills #m3} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/gender_agreement_slot.tsv) the whole dataset.
