...
read_tsv("../orig_table/pharyngeals.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'pharyngeals_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Pharyngeal inventories {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/pharyngeals.tsv) the whole dataset.
