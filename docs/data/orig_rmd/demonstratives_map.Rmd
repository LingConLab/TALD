...
read_tsv("../orig_table/demonstratives.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'demonstratives_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Distance contrasts {.tabset .tabset-fade .tabset-pills #m1} 
...
## Orientation of demonstrative systems (i) {.tabset .tabset-fade .tabset-pills #m2} 
...
## Elevation {.tabset .tabset-fade .tabset-pills #m3} 
...
## Orientation of demonstrative systems (ii) {.tabset .tabset-fade .tabset-pills #m4} 
...
## Most frequent demonstrative pronoun in anaphoric function {.tabset .tabset-fade .tabset-pills #m5} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/demonstratives.tsv) the whole dataset.
