...
read_tsv("../orig_table/numeral_class.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'numeral_class_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Presence of a class suffix in the numeral marker {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_class.tsv) the whole dataset.
