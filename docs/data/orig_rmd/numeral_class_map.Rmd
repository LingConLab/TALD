...
feature_dataset <- read_tsv("../orig_table/numeral_class.tsv", show_col_types = FALSE)
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/numeral_class.tsv) the whole dataset and [its description](https://raw.githubusercontent.com/LingConLab/TALD/master/data/md_description/numeral_class.md).
