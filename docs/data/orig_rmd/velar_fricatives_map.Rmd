...
read_tsv("../orig_table/velar_fricatives.tsv", show_col_types = FALSE, guess_max = 2000) |>
...
'../feature_types.csv' |> 
  ...
  filter(filename == 'velar_fricatives_map.Rmd') |> 
  select(-filename) ->
  feature_types
...
## Velar fricatives {.tabset .tabset-fade .tabset-pills #m1} 
...
[Download](https://raw.githubusercontent.com/LingConLab/TALD/master/data/orig_table/velar_fricatives.tsv) the whole dataset.
