---
title: Distinction between transitive and intransitive imperatives (Maps & Data)
...
See [chapter](058_trans_intrans_imperative.html)
...
```{r, child='data/orig_rmd/trans_intrans_imperative_map.Rmd'}
```
