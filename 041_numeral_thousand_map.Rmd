---
title: Presence of the numeral marker in the numeral ‘1 000’ (Maps & Data)
...
See [chapter](041_numeral_thousand.html)
...
```{r, child='data/orig_rmd/numeral_thousand_map.Rmd'}
```
