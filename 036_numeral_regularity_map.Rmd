---
title: Regularity of the numeral marker (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_regularity.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](036_numeral_regularity.html)
...
```{r, child='data/orig_rmd/numeral_regularity_map.Rmd'}
```
