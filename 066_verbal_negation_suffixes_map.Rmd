---
title: Negation with suffixes (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: July 2025'
bibliography: ./data/orig_bib/verbal_negation_suffixes.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](066_verbal_negation_suffixes.html)
...
```{r, child='data/orig_rmd/verbal_negation_suffixes_map.Rmd'}
```
