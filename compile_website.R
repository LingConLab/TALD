...
file.remove(list.files("docs/images", full.names = TRUE, recursive = TRUE))
file.remove(c(list.files("docs/data", full.names = TRUE), "docs/data", "docs/tests", "docs/html", "docs/DESCRIPTION", "docs/images"))
beepr::beep()
