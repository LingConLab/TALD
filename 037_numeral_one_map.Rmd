---
title: Presence of the numeral marker in the numeral ‘1’ (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: August 2022'
bibliography: ./data/orig_bib/numeral_one.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](037_numeral_one.html)
...
```{r, child='data/orig_rmd/numeral_one_map.Rmd'}
```
