---
title: Numeral Bases (Maps & Data)
author: Maksim Melenchenko
date: 'Last update: September 2022'
bibliography: ./data/orig_bib/numeral_bases.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](051_numeral_bases.html)
...
```{r, child='data/orig_rmd/numeral_bases_map.Rmd'}
```
