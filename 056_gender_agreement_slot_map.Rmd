---
title: Gender agreement slot in nominal inflectional paradigms (Maps & Data)
author: Rita Popova
date: 'Last update: February 2024'
bibliography: ./data/orig_bib/gender_agreement_slot.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [chapter](056_gender_agreement_slot.html)
...
```{r, child='data/orig_rmd/gender_agreement_slot_map.Rmd'}
```
