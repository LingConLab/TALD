---
title: Number of morphological slots in spatial forms (Maps & Data)
...
See [chapter](054_number_of_morphological_slots_in_spatial_forms.html)
...
```{r, child='data/orig_rmd/number_of_morphological_slots_in_spatial_forms_map.Rmd'}
```
