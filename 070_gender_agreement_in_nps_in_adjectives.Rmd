---
title: Gender agreement slot in adjectives
...
See [data and maps](070_gender_agreement_in_nps_in_adjectives_map.html).
...
```{r, child='data/orig_rmd/gender_agreement_in_nps_in_adjectives.Rmd'}
```
