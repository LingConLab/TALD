---
title: Labial approximant and related sounds
author: George Moroz, Vasiliy Zerzele
date: 'Last update: February 2026'
bibliography: ./data/orig_bib/labials.bib
csl: apa.csl
link-citations: true
output:
  html_document:
...
See [data and maps](013_labials_map.html).
...
```{r, child='data/orig_rmd/labials.Rmd'}
```
